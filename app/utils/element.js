...
export const toast = (message = "", timeout = 8100) => {
  const element = createHTMLelement("strong", "generator__alert", message);

  document.body.insertBefore(
    element,
    document.querySelector(".generator__title")
  );
...
export const styleHTMLElement = (element, cssProperty, cssPropertyValue) =>
  (element.style[cssProperty] = cssPropertyValue);

export const getTextContentHTMLElement = (element) => element.innerText;

export const changeTextContentHTMLElement = (element, newContent) =>
